                    ...
                    @foreach ($roles as $role)
                        <tr>
                            ...
                            <td class="text-center font-size-18">
                                <a  class="text-gray m-r-15 anchor-pointer"><i class="ti-pencil" data-toggle="modal" data-target="#role_edit_modal" onclick="PopulateModal('{{ $role->id }}')" ></i></a>
                                <a  class="text-gray anchor-pointer"><i class="ti-trash swal-function" onclick=RoleDelete('{{ $role->id }}');></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
