...
@section('content')
                        ...
                        <table id="users_table" class="table table-hover table-xl">
                            ...
                            <tr>
                                ...
                                <td class="text-center font-size-18">
                                    <a  class="text-gray m-r-15 anchor-pointer"><i class="ti-pencil" data-toggle="modal" data-target="#user_edit_modal" onclick="PopulateModal('{{ $user->id }}')" ></i></a>
                                    <a  class="text-gray anchor-pointer"><i class="ti-trash swal-function" onclick=UserDelete('{{ $user->id }}');></i></a>
                                </td>
                            </tr>
                            @endforeach
                            </tbody>
            ...
            <div class="modal fade" id="user_new_modal">
