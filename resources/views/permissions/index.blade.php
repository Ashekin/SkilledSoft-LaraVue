...
@section('content')
                    ...
                    @foreach ($permissions as $permission)
                        <tr>
                            ...
                            <td class="text-center font-size-18">
                                <a  class="text-gray m-r-15 anchor-pointer"><i class="ti-pencil" data-toggle="modal" data-target="#permission_edit_modal" onclick="PopulateModal('{{ $permission->id }}')" ></i></a>
                                <a  class="text-gray anchor-pointer"><i class="ti-trash swal-function" onclick=PermissionDelete('{{ $permission->id }}');></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
    ...
    <div class="modal fade" id="permission_new_modal">
